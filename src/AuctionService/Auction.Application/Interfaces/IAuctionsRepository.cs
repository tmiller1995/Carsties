...
public interface IAuctionsRepository
{
    ...
    Task<AuctionEntity?> CreateAuctionAsync(AuctionEntity auctionToCreate,
        CancellationToken cancellationToken = default);

    Task CreateAuctionsAsync(IEnumerable<AuctionEntity> auctionsToCreate,
        CancellationToken cancellationToken = default);

    Task<AuctionEntity> UpdateAuctionByIdAsync(AuctionEntity updatedAuction,
        CancellationToken cancellationToken = default);
